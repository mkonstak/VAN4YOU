...
<main style="position: relative; overflow: hidden;">
    ...
    <section class="hero section" style="min-height: 25vh; display: flex; align-items: center; position: relative; overflow: hidden; padding-top: 100px;">
        <div class="container animate-up" style="position: relative; z-index: 2;">
            ...
            <br>
            <div class="glass reveal" style="padding: var(--space-m); max-width: 900px; margin: 0 auto;">
                <h2 style="margin-bottom: var(--space-s); text-align: center;">Náš <span class="text-accent">Příběh</span></h2>
                <div class="story-text" style="color: var(--text-muted);">
                    <p>
                    ...
                    <div style="display: flex; gap: var(--space-m); flex-wrap: wrap; margin-bottom: 1rem;">
    ...
    <section class="section reveal" style="background: linear-gradient(to bottom, transparent, rgba(255,107,53,0.05));">
        <div class="container">
            <h2 style="text-align: center; margin-bottom: var(--space-m);"><span class="text-accent">Obsazenost</span> vozidel</h2>
            <div class="glass calendar-container" style="padding: 10px; border-radius: 16px;">
...
<br><br>
        <div class="container reveal" style="text-align: center;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: var(--space-m); margin-top: var(--space-m);">
                <div class="glass glass-hover" style="padding: var(--space-m);">
